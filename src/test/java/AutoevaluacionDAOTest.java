...
public class AutoevaluacionDAOTest {
    ...
    @Test
    @Order(1)
    void testCrearNuevaAutoevaluacion() throws SQLException, IOException {
    ...
    @Test
    @Order(2)
    void testEliminarAutoevaluacionPorID() throws SQLException, IOException {
    ...
    @Test
    @Order(3)
    void testModificarAutoevaluacion() throws SQLException, IOException {
    ...
    @Test
    @Order(4)
    void testBuscarAutoevaluacionPorID() throws SQLException, IOException {
